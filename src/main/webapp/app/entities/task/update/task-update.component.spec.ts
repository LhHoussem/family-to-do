...
describe('Task Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call ToDoList query and add missing value', () => {
      ...
      const toDos: IToDoList[] = [{ id: '7d9f6fbb-6c68-449b-b60b-20003ac3d219' }];
      task.toDos = toDos;
      ...
      const additionalToDoLists = [...toDos];
    ...
    it('Should update editForm', () => {
      const task: ITask = { id: 'CBA' };
      const toDos: IToDoList = { id: '35e2974d-85b0-43d0-ab24-a021e2d9341d' };
      task.toDos = [toDos];

      activatedRoute.data = of({ task });
      comp.ngOnInit();

      expect(comp.toDoListsSharedCollection).toContain(toDos);
