...
describe('ToDoList Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'to-do-list', component: ToDoListComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.toDoLists?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
