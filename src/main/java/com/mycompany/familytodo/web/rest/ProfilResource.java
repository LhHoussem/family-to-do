...
/**
 * REST controller for managing {@link com.mycompany.familytodo.domain.Profil}.
 */
@RestController
@RequestMapping("/api")
public class ProfilResource {
    ...
    public ResponseEntity<ProfilDTO> updateProfil(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, profilDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<ProfilDTO> partialUpdateProfil(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, profilDTO.getId())
        );
    }
    ...
    public ResponseEntity<ProfilDTO> getProfil(@PathVariable String id) {
