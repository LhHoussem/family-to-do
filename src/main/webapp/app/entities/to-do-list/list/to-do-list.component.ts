...
import { EntityArrayResponseType, ToDoListService } from '../service/to-do-list.service';
...
export class ToDoListComponent implements OnInit {
  ...
  trackId = (_index: number, item: IToDoList): string => this.toDoListService.getToDoListIdentifier(item);
